...
#| out-width: 75%
#| fig-align: center
first_figure <- ggplot(aes(x = weight, y = shootarea, colour = nitrogen), data = flowers) +
  geom_point() +
  geom_smooth(method = "gam", se = FALSE) +
  facet_grid(block ~ treat)
second_figure <- ggplot(aes(x = weight, y = shootarea, colour = nitrogen), data = flowers) +
  geom_point() +
...
`ggplot2` :package: offer the really useful `ggsave()` function which simply saving plots a lot.
