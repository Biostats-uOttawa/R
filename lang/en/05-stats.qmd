...
```{r ss33, echo=TRUE , message=FALSE}
ggplot(mapping = aes(x = smoking, y = mortality), data = smoke) +
	geom_point() +
...
```{r ss40, echo=TRUE , message=FALSE, warning=FALSE}
library(ggfortify)
...
Further information can be found in any of the excellent documents referred to in [Chapter 2](#rhelp).
