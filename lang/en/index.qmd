...
This book started as a fork on github from the excellent [An
introduction to R](https://intro2r.com/) book by Douglas, Roos, Mancini,
...
The book also borrowed and modified section of previous lab manuals
written by [Julien Martin](#sec-julien) developed for biostatistics
classes at uOttawa.

Site that provided a lot of information for the book:

-   [dplyr
    introduction](https://dplyr.tidyverse.org/articles/dplyr.html)
-   [Introduction to
    gam](https://m-clark.github.io/generalized-additive-models/)
-   [Intoduction to gams by Noam
    Ross](https://noamross.github.io/gams-in-r-course/)
...
[Cover
image](https://creator.nightcafe.studio/creation/P0VHCquzSe5LedOzfxwY?ru=1LIicoDlCUOaydR20fvyG3kYCUp1)
was generated via [Nightcafe Ai Art
generator](https://creator.nightcafe.studio). Favicon and hex sticker
...
I share this modified version of the [original
book](https://intro2r.com/) under the license [License Creative Commons
...
#  "Using R", "  4. Figures", paste(rep(emoji("white_check_mark"), 2), collapse = ""), emoji("smiley"),
  ...
  cols_label(
    Bio4x58 = md('[Bio4x58 ![](images/hex/bio4x58_logo_hex.png){width="60px"}](https://biostats-uottawa.github.io/bio4158_course)'),
    Bio8940 = md('[Bio8940 ![](images/hex/bio8940_logo_hex.png){width="60px"}](https://biostats-uottawa.github.io/bio8940_course)')
  ) |>
  tab_options(
