...
- {{< bi bookmarks >}}:uOttawa <https://www.uottawa.ca/faculty-science/professors/julien-martin/>, lab page <https://juliengamartin.github.io>
- {{< bi twitter-x >}}: <https://twitter.com/jgamartin>
- {{< bi github >}}: <https://github.com/juliengamartin>
:::

::: {.content-visible when-format="html"}
- {{< bi bookmarks >}}: [uOttawa page](https://www.uottawa.ca/faculty-science/professors/julien-martin/), [lab page](https://juliengamartin.github.io)
