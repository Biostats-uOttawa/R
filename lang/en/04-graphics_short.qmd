...
See [later](#mult_graphs) in the Chapter for more details about this.
...
```{r fig-ggplot-str2, echo = FALSE, out.width = "50%", fig.align = "center", fig.cap = "Structure of graphics with ggplot2", eval = FALSE}
