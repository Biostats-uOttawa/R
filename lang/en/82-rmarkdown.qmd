...
You can find instructions on how to do this for both Windows and Mac OSX operating systems in @sec-install-rm.
...
Interestingly there is no underline in R markdown syntax by default, for multiple more or less esoteric reasons, but Quarto fixed that problem.
An underline is considered a stylistic element (there may well be other [reasons][underline]).
If you are using Quarto you can simply do`[text to underline]{.underline}` to [underline your text]{.underline}.
