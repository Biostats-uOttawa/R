...
In [Chapter 5](#graphics_r) we made use of the `theme_classic()` function when customising our `ggplot` figures.
...
This is the same trick we used in [Chapter 5](#graphics_r) to alter the `theme_classic()` style of `ggplot2` to make `theme_rbook()`.
...
As we did in [Chapter 5](#graphics_r), we could copy and paste this into our own script and make any changes we deemed necessary.
