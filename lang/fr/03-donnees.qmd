...
Les fonctions `readr` fait partie du paquetage ' [tidyverse][tidyverse] ' et fournit de nombreuses fonctions équivalentes à celles de la base R pour l'importation de données.
