...
- [httpgd](https://cran.r-project.org/web/packages/httpgd/index.html) httpgd : Un paquet R :package: pour fournir un dispositif graphique qui sert de manière asynchrone des graphiques SVG via HTTP et WebSockets.
