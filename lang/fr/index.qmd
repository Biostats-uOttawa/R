...
Sur la page web, tu peux changer de langue via le {{< bi flag >}} dans la barre de navigation. Après avoir changer de langue, tu peux télécharger le document en pdf ou epub pour cet langue {{< bi  download >}}.
...
La version web inclut une barre de navigation incluant des options pour faciliter la lecture {{< bi  body-text >}}, de recherche {{< bi  search >}}, pour changer la couleur {{< bi  toggle-off >}} et pour suggérer des modifications ou reporter des problèmes {{< bi  github >}}.
Tu peux aussi télécharger le document {{< bi  download >}} au format pdf ou epub.
...
Les paquets R dans le texte sont indiqués en utilisant la police de code et suivis de l'icone `r emoji::emoji("package")`, exemple `tidyverse` `r emoji::emoji("package")`.
...
- {{< bi bookmarks >}}:uOttawa <https://www.uottawa.ca/faculty-science/professors/julien-martin/>, site labo <https://juliengamartin.github.io>
- {{< bi twitter-x >}}: <https://twitter.com/jgamartin>
- {{< bi github >}}: <https://github.com/juliengamartin>
:::::

::::: {.content-visible when-format="html"}
- {{< bi bookmarks >}}: [site uOttawa](https://www.uottawa.ca/faculty-science/professors/julien-martin/), [site labo](https://juliengamartin.github.io)
- {{< bi twitter-x >}}: [jgamartin](https://twitter.com/jgamartin)
- {{< bi github >}}: [juliengamartin](https://github.com/juliengamartin)
:::::
